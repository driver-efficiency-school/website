        ...
        <ol class="list-decimal pl-6">
          <li>Permission is granted to temporarily download one copy of the materials on Efficient Driver 2.0's app and website for personal, non-commercial viewing only. This is a license, not a title transfer, and you may not:
            <ol class="list-decimal pl-6">
              ...
              <li>use the app unlawfully or to promote illegal activity, including copyright infringement;</li>
    ...
    <section class="mb-8">
      ...
      <div class="opacity-70">
        <ul class="list-disc pl-6">
          ...
          <li>We collect and use personal information only to fulfill specified purposes, unless consented otherwise or required by law.</li>
          <li>We retain personal information only as long as necessary for those purposes.</li>
          <li>We collect personal information lawfully and fairly, with user knowledge or consent where appropriate.</li>
          <li>We protect personal information with reasonable security against loss, theft, or unauthorized access, disclosure, copying, use, or modification.</li>
          <li>We make our policies on personal information management readily available to customers.</li>
          <li>We are committed to ensuring the confidentiality of personal information through these principles.</li>
        </ul>
      </div>
    </section>
  </div>
