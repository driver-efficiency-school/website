      ...
      >
        <CardHeader class="p-0 gap-0">
          <div class="h-full overflow-hidden flex items-center justify-center">
            <div
              class="w-full aspect-square flex items-center justify-center text-8xl bg-gradient-to-br from-primary/10 to-primary/20 transition-all duration-200 ease-linear group-hover/hoverimg:scale-[1.01]"
            >
              {{ emoji }}
            </div>
          </div>
